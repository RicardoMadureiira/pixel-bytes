      ...
      <main className="mx-auto max-w-5xl px-4 pb-28 space-y-14">
        ...
        <section ref={burgersReveal.ref}>
          <div className="mb-8 flex flex-col items-center gap-2">
            <h2
              className={`text-center font-display text-xl font-bold uppercase tracking-widest text-zinc-100 o$${burgersReveal.isVisible ? "animate-slide-up" : "opacity-0}
            >
              🍔 Escolha seu Buff 🍔
            </h2>
            <div
        ...
        <section ref={drinksReveal.ref}>
          <div className="mb-8 flex flex-col items-center gap-2">
            <h2
              className={`text-center font-display text-xl font-bold uppercase tracking-widest text-zinc-100 op${drinksReveal.isVisible ? "animate-slide-up" : "opacity-0`}
            >
              ⚗️ Poções 🧪
            </h2>
            <div
